...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		type = ResourceType.Add( "~/Content/Upload/Dosyalar" );
		type.Url = BaseUrl + "~/Content/Upload/Dosyalar";
		type.Dir = BaseDir == "" ? "" : BaseDir + "~/Content/Upload/Dosyalar";
		type.MaxSize = 0;
		...
		type = ResourceType.Add( "~/Content/Upload/Resimler/" );
		type.Url = BaseUrl + "~/Content/Upload/Resimler/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "~/Content/Upload/Resimler/";
		type.MaxSize = 0;
